...
$=n\cdot (n-1)\cdot (n-2) \cdots (n-r+1) \cdot \frac{(n-r)!}{(n-r)!} = \frac{n!}{(n-r)!} = {}_nP_r$
:::
...
El número de combinaciones de n objetos tomados r a la vez es el número de subconjuntos, cada uno de tamaño r, que se pueden formar a partir de los n objetos. Este número estará denotado por ${}_nC_r$ o $\binom{n}{r}$
...
${}_5C_3 = \frac{5!}{3!(5-3)!} = \frac{5!}{3!2!} = 10$
